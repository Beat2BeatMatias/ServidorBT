...
public class ServServidorBT {
    ...
    public ServServidorBT(Context context, Handler handler, BluetoothAdapter
            adapter) {
    ...
    private class HiloConexion extends Thread {
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    Log.e(TAG, "HiloConexion.run(): Error al realizar la lectura",
                            e);
        ...
        public void escribir(byte[] buffer) {
            try {
                ...
                Log.e(TAG, "HiloConexion.escribir(): Error al realizar la escritura",
                        e);
            }
        }
    ...
    private class HiloServidor extends Thread {
        ...
        public HiloServidor() {
            ...
            try {
                tmpServerSocket = bAdapter.listenUsingRfcommWithServiceRecord(NOMBRE_SEGURO,
                        UUID_SEGURO);
            } catch (IOException e) {
                Log.e(TAG, "HiloServidor(): Error al abrir el socket servidor",
                        e);
            }
